namespace REstateClient.Json.Converters
{
    using REstate;
    using System;
    ...
    /// </summary>
    /// <seealso cref="REstateClient.Json.JavaScriptConverter" />
    public class TupleConverter : JavaScriptConverter
    {
        ...
        public override object Deserialize(IDictionary<string, object> dictionary, Type type, StringSerializer serializer)
        {
        ...
        public override IDictionary<string, object> Serialize(object obj, StringSerializer serializer)
        {
