namespace REstateClient.Json.Simple
{
    using System;
    ...
    /// <summary>
    /// REstateClient serialization stategy for SimpleJson
    /// </summary>
    public class REstateClientSerializationStrategy : PocoJsonSerializerStrategy
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="REstateClientSerializationStrategy"/> class.
        /// </summary>
        /// <remarks>C# casing of objects will be defaulted to camelCase and enums treated as integers</remarks>
        public REstateClientSerializationStrategy() : this(false, false)
        {
        ...
        public REstateClientSerializationStrategy(bool retainCasing, bool serializeEnumToString)
        {
        ...
        protected override string MapClrMemberNameToJsonFieldName(string clrPropertyName)
        {
            return this.retainCasing
                ...
                : ConvertFirstCharacter(clrPropertyName, x => x.ToLowerInvariant());
        }

        private static string ConvertFirstCharacter(string value, Func<string, string> converter)
        {
